...
if peso/altura**2 < 18.5:
    print('Seu IMC é {:.2f}, e você está abaixo do peso!'.format(
        peso/altura**2))
elif peso/altura**2 >= 18.5 and peso/altura**2 <= 25:
    print('Seu IMC é {:.2f}, e você está no peso ideal!'.format(
        peso/altura**2))
elif peso/altura**2 < 25 and peso/altura**2 <= 30:
    print('Seu IMC é {:.2f}, e você está acima do peso!'.format(
        peso/altura**2))
elif peso/altura**2 < 30 and peso/altura**2 <= 40:
    print('Seu IMC é {:.2f}, e você está com obesidade!'.format(
        peso/altura**2))
else:
    print('Seu IMC é {:.2f}, e você está com obsesidade mórbida!'.format(
        peso/altura**2))
...
if paga == 1:
    ...
    if parce == 2:
        print('Você pagou o preço original do produto em duas parcelas de R${}!'.format(
            preço/2))
    else:
