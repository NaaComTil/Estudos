...
if sala > 1250:
    print(
        f'O aumento do salário é de 10%, agora, quem ganha {sala} passa a ganhar: {sala/100*10+sala}!')
else:
    print(
        f'O aumento do salário é de 15%, agora, quem ganha {sala} passa a ganhar: {sala/100*15+sala}!')
